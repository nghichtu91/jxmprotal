...
import TravelLayoutPage from '@/pages/layout/travel';
...
const routeList: RouteObject[] = [
  {
    path: '/',
    element: <WrapperRouteComponent element={<TravelLayoutPage />} titleId="" />,
    children: [
      {
        path: '/',
        element: <WrapperRouteComponent auth={false} element={<HomePage />} titleId="" />,
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      {
        path: 'info',
        element: <WrapperRouteComponent element={<InfoPage />} titleId="" title="Thông tin tài khoản" />,
      },
      {
        path: 'change-info',
