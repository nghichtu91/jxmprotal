...
import { Button, Card, Col, Divider, Form, Input, notification, Row, Select, Typography } from 'antd';
    ...
    >
      ...
      >
        <Card title="Quên mật khẩu">
          <Form<IUserForgotPassWord> onFinish={onFinish} size="large" layout="vertical">
            <Form.Item
              name="passWord"
              rules={[
                {
            ...
            <Form.Item noStyle>
              <Row gutter={8} justify="center">
                <Col>
                  <Button href="/login" type="link" htmlType="submit">
                    Quay lại đăng nhập
                  </Button>
                </Col>
                <Col>
